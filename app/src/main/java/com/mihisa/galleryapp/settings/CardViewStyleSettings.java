...
import static com.mihisa.galleryapp.CardViewStyle.COMPACT;
import static com.mihisa.galleryapp.CardViewStyle.FLAT;
import static com.mihisa.galleryapp.CardViewStyle.MATERIAL;

public class CardViewStyleSettings extends ThemedSetting {
    public CardViewStyleSettings(ThemedActivity activity) {
        super(activity);
    }
