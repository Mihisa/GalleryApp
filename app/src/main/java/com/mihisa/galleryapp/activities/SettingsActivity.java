...
import com.mihisa.galleryapp.settings.CardViewStyleSettings;
import com.mihisa.galleryapp.settings.ColorsSetting;
import com.mihisa.galleryapp.settings.GeneralSetting;
import com.mihisa.galleryapp.settings.MapProviderSetting;
import com.mihisa.galleryapp.settings.SinglePhotoSetting;
import com.mihisa.galleryapp.util.Security;
import com.mihisa.galleryapp.views.SettingWithSwitchView;
...
public class SettingsActivity extends ThemedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        optionStatusbar.setOnClickListener(v -> {
            updateTheme();
            setStatusBarColor();
        });
    ...
    public void onChangeCardViewStyleClicked(View view) {
        new CardViewStyleSettings(SettingsActivity.this).show();
    }
