...
public class StringUtils {
    ...
    public static String[] asArray(String ... a) {return a;}
    ...
    public static String getPhotoPathRenamedAlbumChange(String olderPath, String albumNewName) {
        ...
        for(int i = 0; i < b.length - 2; i++) c += b[i] + "/";
    ...
    public static void showToast(Context x, String s) {
        Toast t = Toast.makeText(x, s, Toast.LENGTH_LONG);
        t.show();
    }
    ...
    public static String color(String color, String content) {
        return String.format(Locale.ENGLISH, "<font color='%s'>%s</font>", color, content);
    }
