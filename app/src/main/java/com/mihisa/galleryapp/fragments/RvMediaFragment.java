...
import com.mihisa.galleryapp.activities.PaletteActivity;
import com.mihisa.galleryapp.adapters.MediaAdapter;
import com.mihisa.galleryapp.adapters.ProgressAdapter;
...
import com.mihisa.galleryapp.util.Affix;
...
import com.mihisa.galleryapp.util.MimeTypeUtils;
...
public class RvMediaFragment extends BaseFragment {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.select_all).setTitle(getSelectedCount() == getCount()
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.affix:
                ...
                final android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(getActivity(), getDialogStyle());
